...
check(`trace panel renders Source File`,  source.includes('"Source File"') || source.includes("'Source File'"));
check(`trace panel renders Source Row`,   source.includes('"Source Row"') || source.includes("'Source Row'"));
check(`trace panel renders Source Sheet`, source.includes('"Source Sheet"') || source.includes("'Source Sheet'"));
check(`trace panel renders Transaction ID`,
      source.includes('"Transaction ID"') || source.includes("'Transaction ID'"));
check(`trace panel renders Party Name (v2.1.1 invariant)`, source.includes('"Party Name"') || source.includes("'Party Name'"));
check(`trace panel renders Party Key`,    source.includes('"Party Key"') || source.includes("'Party Key'"));
...
check(`OPEN filter logic implemented`,
      ...
      source.includes("t.direction === 'receivable'") &&
      source.includes("t.direction === 'payable'"));
