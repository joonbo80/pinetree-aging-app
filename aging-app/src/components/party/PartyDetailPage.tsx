  ...
  return (
    <div className="party-tab-content">
      ...
      <div className="party-tab-footer">
        ...
        <button type="button" className="btn btn-mono party-export-btn" onClick={() => exportPartyTabCsv(detail, 'transactions')}>
          Export CSV
        </button>
      </div>
    </div>
  ...
  return (
    <div className="party-tab-content">
      ...
      <div className="party-tab-footer stmt-footer">
        ...
        <button type="button" className="btn btn-mono party-export-btn" onClick={() => exportPartyTabCsv(detail, 'statements')}>
          Export CSV
        </button>
      </div>
    </div>
  ...
  return (
    <div className="party-tab-content">
      ...
      <div className="party-tab-footer">
        ...
        <button type="button" className="btn btn-mono party-export-btn" onClick={() => exportPartyTabCsv(detail, 'reviews')}>
          Export CSV
        </button>
      </div>
    </div>
  ...
  return (
    <div className="party-tab-content">
      ...
      <div className="party-tab-footer">
        ...
        <button type="button" className="btn btn-mono party-export-btn" onClick={() => exportPartyTabCsv(detail, 'duplicates')}>
          Export CSV
        </button>
      </div>
    </div>
