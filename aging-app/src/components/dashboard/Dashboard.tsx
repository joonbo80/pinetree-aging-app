    ...
    <main className="app-content dashboard-page">
      ...
      {onOpenAging && (
        <div className="dashboard-workbench-cta">
          <div>
            <span className="dashboard-workbench-cta-title">Statement Collection Workbench</span>
            <span className="dashboard-workbench-cta-hint">
              Prioritized view of overdue receivables, statement mismatches, and items needing follow-up.
            </span>
          </div>
