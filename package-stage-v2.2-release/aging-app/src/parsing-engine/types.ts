...
export interface ReviewItem {
  ...
  partyName: string | null;              // display name; never derive display copy from partyKey
...
export interface StatementLink {
  ...
  sourceRow: number;
  partyKey: string;
  partyName: string;                     // display name from statement block
...
export interface PartyDetail {
  ...
  status: PartyStatus;
  currencyTotals: PartyCurrencyTotal[];
