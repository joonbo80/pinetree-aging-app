...
export interface PreviewTransaction {
  // Stable identity
  //
  // `id` is deterministic — derived from sourceType + sourceFile +
  // sourceRow + sourceContentHash (when available). The same Excel row
  // re-parsed will get the same `id`. Use this as the FK.
  //
